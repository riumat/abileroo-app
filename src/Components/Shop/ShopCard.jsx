...
const ShopCard = ({ shop, likeShop, dislikeShop }) => {
  ...
  return (
    <div className="flex  flex-col lg:flex-row justify-center pb-2 lg:py-0 lg:justify-start items-center gap-5 shadow rounded-lg md:text-[0px] text-emerald-900 bg-white dark:bg-slate-950 dark:text-slate-100">
